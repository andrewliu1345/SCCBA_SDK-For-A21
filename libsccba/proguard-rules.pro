...
-keep public class com.joesmate.sccba.SccbaReader{
    public *;
}
#-dontwarn  com.joesmate.sdk.**
#-keep public class com.joesmate.sdk.**{
# public *;
#}
-dontwarn com.siro.touch.lib.drivers.api.**
-keep public class com.siro.touch.lib.drivers.api.**{
     public *;
}
